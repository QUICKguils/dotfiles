...
call s:hi("Include",        s:nord10_gui,       "", s:nord10_term, "", "",     "")
call s:hi("Define",         s:nord10_gui,       "", s:nord10_term, "", "",     "")
hi! link Macro Define
hi! link PreCondit PreProc

call s:hi("Type",           s:nord7_gui,        "", s:nord7_term,  "", "NONE", "")
call s:hi("StorageClass",   s:nord7_gui,        "", s:nord7_term,  "", "",     "")
call s:hi("Structure",      s:nord7_gui,        "", s:nord7_term,  "", "",     "")
...
call s:hi("Tag",            s:nord9_gui,        "", s:nord9_term,  "", "",     "")
call s:hi("Delimiter",      s:nord6_gui,        "", s:nord6_term,  "", "",     "")
call s:hi("SpecialComment", s:nord10_gui,       "", s:nord10_term, "", "",     "")
